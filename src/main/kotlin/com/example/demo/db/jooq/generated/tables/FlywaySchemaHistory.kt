...
import com.example.demo.db.jooq.generated.indexes.FLYWAY_SCHEMA_HISTORY_S_IDX
import com.example.demo.db.jooq.generated.keys.PK_FLYWAY_SCHEMA_HISTORY
...
open class FlywaySchemaHistory(
    ...
    override fun getPrimaryKey(): UniqueKey<FlywaySchemaHistoryRecord> = PK_FLYWAY_SCHEMA_HISTORY
    override fun getKeys(): List<UniqueKey<FlywaySchemaHistoryRecord>> = listOf(PK_FLYWAY_SCHEMA_HISTORY)
